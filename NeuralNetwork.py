...
"""for i in range(len(Liste5)):
    ri=np.random.randint(len(Liste2))
    point=Liste2[ri][1]
    print(point)"""
defvic=0
for z in range(len(Liste5)):
    ...
    if z>nbMJoués:
        if (Liste2[maxa][-2][2]-Liste2[maxi][-2][2]>0 and Liste2[maxa][-2][2]-Liste2[maxi][-2][2]<0.5)  and ((Liste2[maxa][-2][3]-Liste2[maxa][-2][4])-(Liste2[maxi][-2][3]-Liste2[maxi][-2][4])>5 and (Liste2[maxa][-2][3]-Liste2[maxa][-2][4])-(Liste2[maxi][-2][3]-Liste2[maxi][-2][4])<50):
            #print(Liste2[maxi][0],Liste2[maxa][0])
            #print("VictoireListeProno.append(z)ListeProno.append(z)ListeProno.append(z)ListListeProno.append(z)
            ListeProno.append(0)
            ListeProno.append(z)
    ...
    b1=0
    b2=0
    if Liste5[z]==1 and (Liste2[maxi][-2][2]-Liste2[maxa][-2][2]>=ecart):
        color="b"
    elif Liste5[z]==0 and (Liste2[maxa][-2][2]-Liste2[maxi][-2][2]>=ecart):
        color="g"
    elif Liste5[z]==1 and (Liste2[maxa][-2][2]-Liste2[maxi][-2][2]>=ecart):
        if Liste2[maxa][-2][0]+Liste2[maxa][-2][1]>nbMJ or Liste2[maxi][-2][0]+Liste2[maxi][-2][1]>nbMJ: 
            """print(Liste2[maxa][0],Liste2[maxi][0])
            print(Liste2[maxa][-2][2],Liste2[maxi][-2][2])
            print("Home")"""
            color="black"
        else:
            color="r"
    elif Liste5[z]==0 and (Liste2[maxi][-2][2]-Liste2[maxa][-2][2]>=ecart):
        if Liste2[maxa][-2][0]+Liste2[maxa][-2][1]>nbMJ or Liste2[maxi][-2][0]+Liste2[maxi][-2][1]>nbMJ:
            """print(Liste2[maxi][0],Liste2[maxa][0])
            print(Liste2[maxi][-2][2],Liste2[maxa][-2][2])
            print("Away")"""
            color="cyan"
        else:
            color="r"
    plt.figure(200)
    if Liste2[maxi][-1][2]*a1+b1>=Liste2[maxa][-1][2] and Liste2[maxi][-1][2]<=Liste2[maxa][-1][2]:
        abscisse=Liste2[maxi][-2][2]+ajout
        ordonnée=Liste2[maxa][-2][2]-ajout
    elif Liste2[maxi][-1][2]*a2-b2<=Liste2[maxa][-1][2] and Liste2[maxi][-1][2]>=Liste2[maxa][-1][2]:
        abscisse=Liste2[maxi][-2][2]-ajout
        ordonnée=Liste2[maxa][-2][2]+ajout
    else:
        abscisse=Liste2[maxi][-2][2]
        ordonnée=Liste2[maxa][-2][2]
    #if (abscisse-ordonnée>=ecart or ordonnée-abscisse>=ecart) and Liste5[z]==1:
     #   color="g"
    #elif (ordonnée-abscisse>=ecart or abscisse-ordonnée>=ecart) and Liste5[z]==0:
     #   color="b"
    if z>nbMJoués:
        plt.scatter(abscisse,ordonnée,c=color)
    plt.show()
    Liste6=[abscisse,ordonnée]
    Points.append(Liste6)
    Liste6=Liste2[maxi][-2][2],Liste2[maxa][-2][2]
    points.append(Liste6)
    Liste6=[]
    maxa=0
    maxi=0
...
for i in range(len(y_km)):
    plt.figure(100)
    if y_km[i]==0:
        plt.scatter(points[i][0],Points[i][1],s=100,c='red')
    elif y_km[i]==1:
        plt.scatter(points[i][0],Points[i][1],s=100,c='blue')
    elif y_km[i]==2:
        plt.scatter(points[i][0],Points[i][1],s=100,c='black')
    else:
        plt.scatter(points[i][0],Points[i][1],s=100,c='green')
    plt.show()
color="y"
Resultat=0
Resultat2=0
...
for z in range(0,nbMatchs):
    ...
    if (Liste2[la][-1][2]-Liste2[li][-1][2]>0 and Liste2[la][-1][2]-Liste2[li][-1][2]<0.5) and ((Liste2[la][-1][3]-Liste2[la][-1][4])-(Liste2[li][-1][3]-Liste2[li][-1][4])>5 and (Liste2[la][-1][3]-Liste2[la][-1][4])-(Liste2[li][-1][3]-Liste2[li][-1][4])<50) :
            ...
            plt.scatter(Liste2[la][-1][2]-Liste2[li][-1][2],(Liste2[la][-1][3]-Liste2[la][-1][4])-(Liste2[li][-1][3]-Liste2[li][-1][4]),c="y")
            ...
            plt.scatter(Liste2[li][-1][2]-Liste2[la][-1][2],(Liste2[li][-1][3]-Liste2[li][-1][4])-(Liste2[la][-1][3]-Liste2[la][-1][4]),c="y")
for i in range(0,len(ListeProno),6):
    ...
    if ListeProno[i]==Liste5[ListeProno[i+1]]:
        ...
        PronoReussi+=1
        color="b"
        plt.scatter(ListeProno[i+3],ListeProno[i+4],c=color)
...
for i in range(0,len(ListePronoExt),6):
    ...
    if ListePronoExt[i]==Liste5[ListePronoExt[i+1]]:
        ...
        PronoReussi2+=1
        plt.scatter(ListePronoExt[i+3],ListePronoExt[i+4],c=color)
...
print("")
#print(ecartProno5/PronoReussi2)
print("")
print(ecartProno6/PronoRater2)
print("")
#print(ecartProno7/PronoReussi2)
print("")
...
#for i in range(len(points)-nbMatchs):
#print(points[i],Liste1[i])
epochs=[]
...
for i in range(nbEpochs):
    ...
    print(PredictDeep(nbMatchs,0.8))
if nbEpochs>0:
    PronoMatch2=PredictDeep(nbMatchs,0.8)
    print(PronoMatch2)
ListeBest=[]
for i in range(nbEpochs):
    print("       EPOCHS NUMBER ",i+1)
...
if nbEpochs>0:
    PronoMatch2=Predict(nbMatchs,0.8)
print(PronoMatch)
print("")
print(PronoMatch2)
print("")
